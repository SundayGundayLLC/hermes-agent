...
AUTHOR_MAP = {
    "marcus@sundaygundayllc.com": "sdgdllc",  # PR #8 (SDGD Kanban worker capacity transparency)
    "me@dannyfranca.com": "dannyfranca",  # PR #46204 (Kanban PR-feedback respawn unblock)
